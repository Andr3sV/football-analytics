#!/usr/bin/env python3
"""
Monitor the progress of the full detailed scraper
"""
import pandas as pd
import os
import time
...
def check_progress():
    ...
    progress_files = glob.glob('players_FULL_DETAILED_PROGRESS_*.csv')
    ...
    if progress_files:
        ...
        try:
            ...
            # Show recent players
            print(f"\n=== RECENT PLAYERS ===")
            sample_cols = ['full_name', 'team_name', 'competition', 'age', 'nationality', 'position']
...
def main():
    """Monitor progress"""
    print("Monitoring full detailed scraper progress...")
